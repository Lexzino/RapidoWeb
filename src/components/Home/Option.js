...
export default function SeacrhTags() {
  ...
  return (
    ...
    <div className="w-11/12 pt-[72px] mx-auto 2xl:max-w-[1161px]">
         ...
         <h2 className="text-[23px] w-[1066px] font-medium leading-[30px] text-[#1A4402] text-center mb-[30px]">
         Discover top-rated care <span className="font-thin italic text-[#1A440280]">at the best prices, including weight loss to mental health & more.</span> Schedule 
         your appointment <span className="font-thin italic text-[#1A440280]">in just minutes. and see a doctor,</span> whether you have insurance or not!
</h2>
