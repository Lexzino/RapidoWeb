...
export default function DialogDefault({ open, onClose }) {
  return (
    ...
    <Dialog
      ...
      open={open}
      handler={onClose}
      className="bg-green-light 2xl:min-w-[900px] relative p-5 md:p-9"
    >
      <DialogBody
      ...
      >
        ...
        <p className="f-f-r text-lg sm:text-lg md:text-3xl text-black mt-7">
          ...
          <br />
          In the meantime, feel free to explore other areas of our platform or
          reach out to us for assistance. We're here to help!<br />
          <br />
